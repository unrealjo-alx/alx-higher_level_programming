...
class Rectangle:
    ...
    def __repr__(self):
        """
        Returns:
            string: Representation of the rectangle as Class(x,y).
        """
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Raises:
            TypeError: if one the arguments aren't an instance of Rectangle.
    ...
    def square(cls, size=0):
        """Class method that a new cls instance
